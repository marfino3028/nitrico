...
<tr>
    ...
    <i class="fa fa-edit"></i> Edit
      ...
      <a href="<?php echo base_url('admin/kategori_galeri/delete/'.$kategori_galeri->id_kategori_galeri) ?>" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i> Hapus</a>
      </div>
