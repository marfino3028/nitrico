...
<button class="btn btn-info btn-sm" data-toggle="modal" data-target="#activate<?php echo $i ?>">
    <i class="fa fa-check"></i> Non Aktifkan
</button>

<?php }else{ ?>
<button class="btn btn-success btn-sm" data-toggle="modal" data-target="#activate<?php echo $i ?>">
