...
<div class="btn-group">
    ...
    <button type="button" class="btn btn-success " data-toggle="modal" data-target="#exampleModal">
      <i class="fa fa-plus"></i> Tambah UP Baru
    </button>  
    <a href="<?php echo base_url('admin/client') ?>" class="btn btn-info ">
  ...
  <tr>
    ...
    <td>
      <div class="btn-group">
        ...
        <a href="<?php echo base_url('admin/client/delete_up/'.$up->id_up.'/'.$client->id_client) ?>" class="btn btn-danger btn-sm" onclick="confirmation(event)"><i class="fa fa-trash"> Delete</i></a>
      </div>
