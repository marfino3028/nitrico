...
// Form open
echo form_open_multipart(base_url('admin/produk/edit/'.$produk->id_produk),'id="tambah" class="form-horizontal"');
?>
...
<div class="form-group row">
	...
	<div class="col-sm-3">
		<select name="id_kategori_produk" class="form-control">
			<?php foreach($kategori_produk as $kategori_produk) { ?>
				<option value="<?php echo $kategori_produk->id_kategori_produk ?>" <?php if($kategori_produk->id_kategori_produk ==$produk->id_kategori_produk) { echo "selected"; } ?>
	...
	<div class="col-sm-3">
		<select name="status_produk" class="form-control">
			...
			<option value="Draft"  
			<?php if($produk->status_produk=="Draft") { echo "selected"; } ?>>Simpan sebagai draft</option>
		</select>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-sm-6">
		<input type="text" name="nama_produk" class="form-control" placeholder="Nama Produk" required value="<?php echo $produk->nama_produk ?>">
		<small class="text-gray">Setiap awal kata gunakan huruf capital. Misal: <strong>Coklat Nitrico</strong></small>
	</div>
	<div class="col-sm-2">
		<input type="text" name="kode_produk" class="form-control" placeholder="Kode Produk" required value="<?php echo $produk->kode_produk ?>">
...
<div class="form-group row">
	...
	<div class="col-sm-9">
		<textarea name="isi" id="isi"  class="form-control konten" placeholder="Deskripsi Produk"><?php echo $produk->isi ?></textarea>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-sm-4">
		<textarea name="deskripsi" class="form-control" placeholder="Deskripsi Produk"><?php echo $produk->deskripsi ?></textarea>
...
<div class="form-group row">
	...
	<div class="col-sm-3">
		<input type="number" name="harga_jual" class="form-control" placeholder="Harga kelas" value="<?php echo $produk->harga_jual ?>">
		<small class="text-gray">Harga jual</small>
	</div>
	<div class="col-sm-3">
		<input type="number" name="harga_beli" class="form-control" placeholder="Harga Beli" value="<?php echo $produk->harga_beli ?>">
...
<div class="form-group row">
	...
	<div class="col-sm-3">
		<input type="number" name="harga_terendah" class="form-control" placeholder="Harga eceran terendah" value="<?php echo $produk->harga_terendah ?>">
		<small class="text-gray">Harga eceran terendah</small>
	</div>
	<div class="col-sm-3">
		<input type="number" name="harga_tertinggi" class="form-control" placeholder="Harga eceran tertingi" value="<?php echo $produk->harga_tertinggi ?>">
...
<div class="form-group row">
	...
	<div class="col-sm-3">
		<select name="jenis_diskon" class="form-control">
			...
			<?php if($produk->jenis_diskon=="Persentase") { echo "selected"; } ?>>Persentase (%)</option>
		</select>
		<small class="text-gray">Jenis diskon</small>
	</div>
	<div class="col-sm-3">
		<input type="number" name="besar_diskon" class="form-control" placeholder="Besar Diskon" value="<?php echo $produk->besar_diskon ?>">
...
<div class="form-group row">
	...
	<div class="col-sm-3">
		<input type="text" name="mulai_diskon" class="form-control tanggal" placeholder="dd-mm-yyyy" value="<?php echo $this->website->tanggal_id($produk->mulai_diskon) ?>">
		<small class="text-gray">Format: dd-mm-yyyy</small>
	</div>
	<div class="col-sm-3">
		<input type="text" name="selesai_diskon" class="form-control tanggal" placeholder="dd-mm-yyyy" value="<?php echo $this->website->tanggal_id($produk->selesai_diskon) ?>">
		<small class="text-gray">Format: dd-mm-yyyy</small>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-sm-3">
		<input type="number" name="jumlah_order_min" class="form-control" placeholder="Jumlah minimal" value="<?php echo $produk->jumlah_order_min ?>">
		<small class="text-gray">Jumlah <strong>minimal</strong> order dalam 1 kelas</small>
	</div>
	<div class="col-sm-3">
		<input type="number" name="jumlah_order_max" class="form-control" placeholder="Jumlah maksimal" value="<?php echo $produk->jumlah_order_max ?>">
...
<div class="form-group row">
	...
	<div class="col-sm-2">
		<input type="text" name="satuan" class="form-control" placeholder="Satuan" value="<?php echo $produk->satuan ?>">
		<small class="text-gray">Misal: Buah, Bungkus. Pak, Kilogram, Gram</small>
	</div>
	<div class="col-sm-2">
		<input type="number" name="berat" class="form-control" placeholder="Berat" value="<?php echo $produk->berat ?>">
		<small class="text-gray">Dalam satuan <strong>gram</strong></small>
	</div>
	<div class="col-sm-2">
		<input type="text" name="ukuran" class="form-control" placeholder="Ukuran" value="<?php echo $produk->ukuran ?>">
...
<div class="form-group row">
	...
	<div class="col-sm-3">
		<input type="number" name="stok" class="form-control" placeholder="Stok" value="<?php echo $produk->stok ?>">
		<small class="text-gray">Format angka.</small>
	</div>
	<div class="col-sm-3">
		<input type="number" name="urutan" class="form-control" placeholder="Urutan" value="<?php echo $produk->urutan ?>">
		<small class="text-gray">Format angka</small>
	</div>
</div>
