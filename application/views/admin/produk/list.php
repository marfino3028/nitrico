 <?php 
        ...
        if($this->uri->segment(3) != "") { 
          ?>
          <p class="text-right"><a href="<?php echo base_url('admin/'.$url_navigasi) ?>" class="btn btn-success btn-sm">
            <small ><i class="fa fa-arrow-circle-left"></i> Kembali</small></a></p>
            <hr>
          <?php } ?>
          
<?php

echo form_open(base_url('admin/produk/cari'), array('method' => 'get'),' class="form-horizontal"');
?>
<div class="row">
  ...
  <div class="col-md-6">
    ...
    <div class="input-group">                  
      <input type="text" name="keywords" class="form-control" placeholder="Ketik kata kunci pencarian produk...." value="<?php if(isset($_POST['keywords'])) { echo set_value('keywords'); }elseif($this->uri->segment(3)=="cari") { echo $keywords; } ?>" required>
        ...
        <tbody>
          ...
          <?php $i=1; foreach($produk as $produk) { ?>
            ...
            <tr class="odd gradeX">
              ...
              <td><a href="<?php echo base_url('admin/produk/kategori/'.$produk->id_kategori_produk) ?>">
                ...
                <br>
                  <small>Harga beli: <?php echo number_format($produk->harga_beli,'0',',','.') ?>
                    ...
                    <br>Periode: <?php echo $this->website->tanggal_id($produk->mulai_diskon) ?> s/d <?php echo $this->website->tanggal_id($produk->selesai_diskon); ?>
                  </small>
                </td>
                <td><a href="<?php echo base_url('admin/produk/status_produk/'.$produk->status_produk) ?>">
                ...
                <td><?php echo $produk->stok ?> <?php echo $produk->satuan ?></td>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <a href="<?php echo base_url('admin/gambar_produk/produk/'.$produk->id_produk) ?>" 
                        class="btn btn-success btn-sm"><i class="fa fa-image"></i> Gambar</a>

                        <a class="btn btn-info btn-sm" href="<?php echo base_url('produk/detail/'.$produk->slug_produk) ?>" target="_blank"><i class="fa fa-eye"></i></a>


                        <a href="<?php echo base_url('admin/produk/edit/'.$produk->id_produk) ?>" 
                          class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                          <a href="<?php echo base_url('admin/produk/delete/'.$produk->id_produk) ?>" class="btn btn-danger btn-sm delete-link"><i class="fa fa-trash"></i></a>
                        </div>
                        <div class="clearfix"><br></div>
                        <div class="btn-group btn-block">
                          <a href="<?php echo base_url('admin/produk/funnel/'.$produk->id_produk) ?>" 
                        class="btn btn-success btn-sm"><i class="fa fa-heart"></i> Product Knowledge</a>
                        </div>
                      </td>
                    </tr>
