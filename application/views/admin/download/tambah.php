...
// Form open
echo form_open_multipart(base_url('admin/download/tambah'),array('class'	=> 'form-horizontal'));
?>
...
<div class="col-md-9">
<textarea name="isi" id="isi" class="form-control konten" placeholder="Isi download"><?php echo set_value('isi') ?></textarea>
</div>
</div>
