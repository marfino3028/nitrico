...
<tr>
    ...
    <i class="fa fa-edit"></i> Edit
      ...
      <a href="<?php echo base_url('admin/kategori_staff/delete/'.$kategori_staff->id_kategori_staff) ?>" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i> Hapus</a>
      </div>
