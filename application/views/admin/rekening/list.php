...
<?php
echo form_open(base_url('admin/rekening/proses'));
?>
<div class="row">
...
<tbody>
    ...
    <?php $i=1; foreach($rekening as $rekening) { ?>
      ...
      <td>
        <?php if($rekening->gambar != "") { ?>
            <img src="<?php echo base_url('assets/upload/image/thumbs/'.$rekening->gambar) ?>" width="60" class="img img-responsive">
    ...
    <td>
        ...
        <a href="<?php echo base_url('admin/rekening/edit/'.$rekening->id_rekening) ?>" 
          ...
          <a href="<?php echo base_url('admin/rekening/delete/'.$rekening->id_rekening) ?>" class="btn btn-danger btn-sm  delete-link">
