...
// Form buka 
				echo form_open_multipart(base_url('admin/kategori_produk'),array(	'class'	=> 'form-horizontal'));
				?>
				<div class="row form-group">
					<label class="col-md-3">Nama kategori produk</label>
					<div class="col-md-8">
						<input type="text" name="nama_kategori_produk" class="form-control" placeholder="Nama kategori produk" value="<?php echo set_value('nama_kategori_produk') ?>" required>
					</div>
				</div>
