<?php echo form_open_multipart(base_url('admin/staff/tambah'),'id="tambah" class="form-horizontal"') ?>
...
<div class="form-group row">
  ...
  <div class="col-sm-9">
    <div class="form-group btn-group">
      ...
      <a href="<?php echo base_url('admin/staff') ?>" class="btn btn-secondary "><i class="fa fa-times"></i> Kembali</a>
    </div>
  </div>
</div>
