...
tinymce.init({
  selector: '.konten',
  height: 300,
  content_css: '<?php echo base_url() ?>assets/template/assets/vendor/bootstrap/css/bootstrap.min.css',
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo base_url('signin/logout') ?>"><i class="fa fa-sign-out-alt"></i> Logout</a>
        </div>
      </div>
    </div>
  </div>
