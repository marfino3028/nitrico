...
echo form_open_multipart(base_url('partner/akun/profil/'),'id="tambah" class="form-horizontal"') ?>
...
<div class="form-group row">
  ...
  <div class="col-md-4">
    <input type="text" name="tanggal_lahir" class="form-control tanggal" placeholder="dd-mm-yyyy" value="<?php echo $this->website->tanggal_id($client->tanggal_lahir) ?>" >
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-sm-9">
    <div class="btn-group">
      ...
      <a href="<?php echo base_url('member/akun') ?>" name="reset" class="btn btn-warning btn-lg"><i class="fas fa-redo"></i> Kembali</a>
    </div>
  </div>
</div>
