<div class="row">
	<div class="col-md-7">
		...
		<p class="text-center">
			<img src="<?php if($client->gambar =="") { echo $this->website->icon(); }else{ echo base_url('assets/upload/client/thumbs/'.$client->gambar); } ?>" style="max-width: 150px; height: auto;" class="img img-circle img-thumbnail">
		</p>
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Pengguna" value="<?php echo $client->nama ?>">
			</div>
		</div>
		...
		<div class="form-group row">
			<label class="col-sm-3 control-label text-right">Username/Email <span class="text-danger">*</span></label>
			<div class="col-sm-9">
				<input type="email" name="email" class="form-control" placeholder="Username" value="<?php echo $client->email ?>" readonly disabled>
			</div>
		</div>

		<div class="form-group row">
			<label class="col-sm-3 control-label text-right">Status <span class="text-danger">*</span></label>
			<div class="col-sm-9">
				<input type="text" name="status_client" class="form-control" placeholder="Akses level" value="<?php echo $client->status_client ?>" readonly disabled>
			</div>
		</div>
