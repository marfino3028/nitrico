              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <hr>
                    <p><?php echo $this->website->tagline() ?></p>
                    <hr>
                  </div>
                  <?php echo form_open(base_url('login')) ?>
                  <input type="hidden" name="pengalihan" value="<?php if($this->session->userdata('pengalihan')=="") {}else{ echo $this->session->userdata('pengalihan'); } ?>">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url('login/lupa') ?>">Lupa Password?</a> | <a class="small" href="<?php echo base_url() ?>">Kembali ke Beranda</a>
                  </div>
                </div>
              </div>
            </div>
