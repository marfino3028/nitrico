      ...
      <div class="col-lg-12 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
        <div class="kotak">
          <div class="row">
            ...
            <div class="col-md-12">
              <p class="text-right">
                <a href="<?php echo base_url('pemesanan/cetak/'.$pemesanan->token_transaksi) ?>" class="btn btn-danger btn-sm" target="_blank">
              ...
              <hr>
              <p>Jika Anda telah melakukan pembayaran. Anda dapat melakukan <a href="<?php echo base_url('pembayaran/konfirmasi') ?>">Konfirmasi Pembayaran</a> atau <a href="<?php echo base_url('produk') ?>">Melihat Produk Lainnya</a></p>
            </div>
          </div>
        </div>
      </div>
